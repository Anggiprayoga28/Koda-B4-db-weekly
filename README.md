...
Dokumen ini menjelaskan struktur database yang digunakan untuk sistem Coffee Shop.  
Database dirancang agar scalable, fleksibel, dan mendukung fitur seperti katalog produk, promo, cart, order, review, dan manajemen pengguna.
